...
final class RecipeJarUITests: XCTestCase {
    ...
    private func waitForHomeScreen() -> Bool {
        let title = app.staticTexts["RecipeJar"]
    ...
    func testHomeScreenShowsTitle() {
        XCTAssertTrue(waitForHomeScreen(), "Home screen title 'RecipeJar' should appear")
    }

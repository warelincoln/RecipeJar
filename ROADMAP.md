...
- **Remaining work:** Deploy Fastify to a cloud host (Dockerfile and guide ready in `docs/PRODUCTION_DEPLOY.md`). Customize Supabase email templates. Configure Supabase Site URL and redirect URL allowlist. These are pre-TestFlight deployment tasks, not code changes.
